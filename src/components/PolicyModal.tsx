              ...
              {isPrivacy ? (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="list-disc pl-8 space-y-2 text-white/60">
                      <li>Answer project queries, deliver consulting scopes, and maintain ongoing startup accounts under Emvilo services.</li>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="pl-4">
                      ...
                      <br />
                      <span className="text-brand-primary font-mono select-all">shiva@emvilo.com</span>
                    </p>
                  </div>
                </>
              ) : (
                <>
                  <p>
                    By accessing or interacting with this portfolio or the startup workspace of <strong>Emvilo</strong> (owned/operated by <strong>Shivanagouda Patil</strong>), you agree to be bound by these Terms of Service, all applicable laws and regulations, and agree that you are responsible for compliance with any local jurisdictions.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <ul className="list-disc pl-8 space-y-2 text-white/60">
                      ...
                      <li>Attempt to decompile, reverse engineer, or crack database indices of any software contained here or on Emvilo servers.</li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="pl-4">
                      In no event shall Shivanagouda Patil, Emvilo, or its verified suppliers be liable for any damages (including, without limitation, damages for loss of business profit, data corruption, or operational interruption) arising out of the use or inability to use the digital services.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="pl-4">
                      Any claim relating to this website or Emvilo services shall be governed by the laws of Karnataka, India, without regard to its conflict of law provisions.
                    </p>
                  </div>
                </>
              )}

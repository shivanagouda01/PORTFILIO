      ...
      <div className="max-w-7xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative w-64 h-64 md:w-80 md:h-80 group">
            ...
            <ThreeDTilt intensity={28} className="w-full h-full rounded-3xl relative">
              {/* Floating Holographic Badge 2: bottom-right */}
              <div 
                className="absolute -bottom-4 -right-6 z-20 px-4 py-2 rounded-xl border border-white/15 glass shadow-lg flex items-center gap-2 select-none pointer-events-none"
              ...
              <div
                className="absolute inset-[15%] rounded-full border border-dashed border-white/15 opacity-50 z-10 pointer-events-none"
                style={{ transform: "translateZ(35px) rotate(45deg)" }}
              />
        ...
        <div className="order-1 md:order-2 text-center md:text-left">
          <ThreeDTilt intensity={10} className="w-full">
            <div className="p-4 rounded-3xl" style={{ transformStyle: "preserve-3d" }}>
              <motion.div
              ...
              >
                <Animated3DText text="Shivanagouda" hoverZ={50} /> <br /> 
                <span className="text-brand-primary">
                  <Animated3DText text="Patil" hoverZ={60} />
                </span>
              </motion.h1>
